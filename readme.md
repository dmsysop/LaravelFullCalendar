...
[![Latest Stable Version](https://poser.pugx.org/dmsysop/laravelfullcalendar/v/stable)](https://packagist.org/packages/dmsysop/laravelfullcalendar) [![Total Downloads](https://poser.pugx.org/dmsysop/laravelfullcalendar/downloads)](https://packagist.org/packages/dmsysop/laravelfullcalendar) [![Latest Unstable Version](https://poser.pugx.org/dmsysop/laravelfullcalendar/v/unstable)](https://packagist.org/packages/dmsysop/laravelfullcalendar) [![License](https://poser.pugx.org/dmsysop/laravelfullcalendar/license)](https://packagist.org/packages/dmsysop/laravelfullcalendar)
...
Require the package with composer using the following command:
    ...
    composer require dmsysop/laravelfullcalendar

Or add the following to your composer.json's require section and `composer update`

```json
"require": {
	"composer require dmsysop/laravelfullcalendar": "~1.0"
}
```
...
```php
DMSysOp\LaravelFullcalendar\ServiceProvider::class,
```

And optionally create an alias:

```php
'Calendar' => DMSysOp\LaravelFullcalendar\Facades\Calendar::class,
...
Alternatively, you can use an existing class and have it implement `DMSysOp\LaravelFullcalendar\Event`. An example of an Eloquent model that implements the `Event` interface:

```php
class EventModel extends Eloquent implements \DMSysOp\LaravelFullcalendar\Event
{
...
If you wish for your existing class to have event IDs, implement `\DMSysOp\LaravelFullcalendar\IdentifiableEvent` instead. This interface extends `\DMSysOp\LaravelFullcalendar\Event` to add a `getId()` method:

```php
class EventModel extends Eloquent implements \DMSysOp\LaravelFullcalendar\IdentifiableEvent
{
...
```php
<?php
class CalendarEvent extends \Illuminate\Database\Eloquent\Model implements \DMSysOp\LaravelFullcalendar\Event
{
	//...
...
$eloquentEvent = EventModel::first(); //EventModel implements DMSysOp\LaravelFullcalendar\Event
